...
- Propose a descriptive filename under `planning/docs/` (e.g., `planning/docs/<date>-<topic>.md`), confirm whether to save immediately, and only write the file once approval is given. Create the directory path when it does not already exist.
